...
import { emptyTradePanel } from 'actions/TradePanel';
import { saveLastTradePage } from 'lightcone/api/localStorgeAPI';
import { setMarket } from 'actions/market/CurrentMarket';
import { updateOrderBooksLevel } from 'actions/market/OrderBook';
