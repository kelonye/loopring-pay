...
import {
  ...
  extendTrades,
  fetchTradeHistory,
} from 'actions/market/TradeHistory';

import { LOGGED_IN } from 'actions/DexAccount';
import { fetchMyAccountPage, updateBalance } from 'actions/MyAccountPage';
import {
...
import { updateSocketAllOrder } from 'actions/MyOrderPage';
import { updateTicker } from 'actions/market/Ticker';
